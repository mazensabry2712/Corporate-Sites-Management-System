                    ...
                    <form id="yourFormId" action="{{ route('project.update', $project->id) }}" method="POST"
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col">
                                ...
                                <select id="ds" name="ds_id" class="form-control SelectBox"
                                    onchange="console.log(this.value)">
                                    <option value="" disabled selected>Suppliers</option>
                                    @foreach ($ds as $dss)
                                        <option value="{{ $dss->id }}"
                                            {{ $project->ds_id == $dss->id ? 'selected' : '' }}>
                                            {{ $dss->dsname }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col">
                                ...
                                <select name="cust_id" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    ...
                                    @foreach ($custs as $cust)
                                        <option value="{{ $cust->id }}" @selected($project->cust_id == $cust->id)> {{ $cust->name }}</option>
                                    @endforeach
                                </select>
                            </div> --}}
                            <div class="col">
                                <label for="cust" class="control-label">Customer Name</label>
                                <select id="cust" name="cust_id" class="form-control SelectBox"
                                    onchange="console.log(this.value)">
                                    <option value="" disabled selected>Customer Name</option>
                                    @foreach ($custs as $cust)
                                        <option value="{{ $cust->id }}"
                                            {{ $project->cust_id == $cust->id ? 'selected' : '' }}>
                                            {{ $cust->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col">
                                ...
                                <select name="name" class="form-control SelectBox"
                                    onclick="console.log($(this).val())" onchange="console.log('change is firing')">
                                    <!--placeholder-->
                                    <option value="" selected disabled> AC Manager </option>
                                    @foreach ($aams as $aam)
                                        <option value="{{ $aam->id }}" @selected($project->aams_id == $aam->id)>
                                            {{ $aam->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <select name="name" class="form-control SelectBox"
                                    ...
                                    @foreach ($ppms as $ppm)
                                        <option value="{{ $ppm->id }}" @selected($project->ppms_id == $ppm->id)>
                                            {{ $ppm->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="number" class="form-control" id="customer_po_duration"
                                    ...
                                    value="{{ $project->customer_po_duration }}">
                            </div>
